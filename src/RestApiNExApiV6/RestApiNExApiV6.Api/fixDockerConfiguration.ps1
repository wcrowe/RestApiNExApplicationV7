...
$currLocationSolutionFile =  Join-Path $currLocationSolution "RestApiNExApiV6.sln"
$content = Get-Content -Path $currLocationSolutionFile
$newContent = $content.Replace("RestApiNExApiV6\docker-compose\docker-compose.dcproj", "docker-compose.dcproj")
